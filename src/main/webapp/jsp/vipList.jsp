                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-2">
                                <select id="select02" class="chzn-select" style="width: 150px">
                                    <%-- 消费能力 --%>
                                    <option>请选择</option>
                                    <option>小于等于100</option>
                                    <option>大于100小于等于200</option>
                                    <option>大于200小于等于500</option>
                                    <option>大于500小于等于1000</option>
                                    <option>大于1000</option>
                                </select>
                            </div>
                            <label class="col-lg-2 control-label" >会员名字</label>
                            <div class="col-lg-2">
                                    <div class="form-group">
                                        <input class="form-control" placeholder="请输入会员姓名" type="text">
                                    </div>
                            </div>
                            <label class="col-lg-2 control-label" for="select04">会员核销</label>
                            <div class="col-lg-2">
                                <select id="select04" class="chzn-select" style="width: 150px">
                                    <%-- 消费能力 --%>
                                    <option>请选择</option>
                                    <option>已核销</option>
                                    <option>未核销</option>
